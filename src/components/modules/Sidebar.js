...
function Sidebar({ category }) {
  return (
    <sidebar className="absolute top-0 md:relative flex items-center justify-center md:justify-start bg-white w-full md:w-60 h-fit space-y-3 shadow-normal p-2 md:p-6 rounded-md">
